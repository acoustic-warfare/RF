...
stream_cmd.time_spec = uhd.libpyuhd.types.time_spec(usrp.get_time_now().get_real_secs() + 0.50)
...
while nsamps != 0 or waiting_to_start:
    ...
    print("more fragments: " + str(metadata.more_fragments) + ", sum:" + str(np.sum(recv_buffer)))
    #print(recv_buffer)
