...
iq_samples = np.random.randn(num_antennas, num_samples) + 1j * np.random.randn(num_antennas, num_samples)
...
#scanning_vectors = de.gen_scanning_vectors_optimized(num_antennas, (x,y,thetas))
