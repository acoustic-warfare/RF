...
def receive_samples(usrp, num_samples, bandwidth, center_freq, sample_rate):
    ...
    stream_cmd.stream_now = False #Ensure that streaming starts immediately and aligned
    stream_cmd.time_spec = uhd.libpyuhd.types.time_spec(usrp.get_time_now().get_real_secs() + 0.5)
